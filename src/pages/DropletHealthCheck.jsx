...
// Static data showing droplet is healthy
const HEALTH_DATA = {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" onClick={() => setLastCheck(new Date())}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-sm mt-2 space-y-1">
              ...
              <div>Evaluations: {health.heartbeat.evaluations.toLocaleString()}</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-sm space-y-1">
              <div>POST errors: {health.connectivity.post_errors}</div>
              <div>Non-2xx: {health.connectivity.non_2xx}</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-sm mt-2">{health.signal_flow.signals} signals/hr</div>
          </CardContent>
        </Card>
      </div>
